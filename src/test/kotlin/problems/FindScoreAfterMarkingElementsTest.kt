...
class FindScoreAfterMarkingElementsTest {
    ...
    fun `case 9`() {
        ...
        assertEquals(212, solution.findScore(nums,1))
    }
    @Test
    fun `case 10`() {
